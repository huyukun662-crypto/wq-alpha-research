...
class SrAlpha(CVBondAlphaBase):
    name = 'option__cb_iv_ts'
    description = 'option cheapness measured against the bond own implied-vol history'
    alpha_definition = 'z(neut(-rank(zscore(IV, 250))))'
